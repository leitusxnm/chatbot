...
const first = numberOfOnePage * page - numberOfOnePage;
 ...
 const text = `\nPage Number: (${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)})\n\n𝗕𝗢𝗧 𝗢𝗣𝗘𝗥𝗔𝗧𝗢𝗥 : Lewyn`;
    var link = [
"https://i.imgur.com/qVVKJbS.gif",
"https://i.imgur.com/KW1mEYV.gif",
"https://i.imgur.com/UmSUfzy.gif",
"https://i.imgur.com/xJiWHMJ.gif",
"https://i.imgur.com/0WBiax7.gif",
"https://i.imgur.com/xxqw37x.gif",
      ]
...
const leiamname = getText("moduleInfo", command.config.name, command.config.description, `${(command.config.usages) ? command.config.usages : ""}`, command.config.commandCategory, command.config.cooldowns, ((command.config.hasPermssion == 0) ? getText("user") : (command.config.hasPermssion == 1) ? getText("adminGroup") : getText("adminBot")), command.config.credits);
  ...
  var link = [ 
"https://i.imgur.com/gEHSlIq.gif",
"https://i.imgur.com/8PZzuKt.gif",
"https://i.imgur.com/ltJmP6Z.gif",
"https://i.imgur.com/ARVhFIy.gif",
  ]
